...
export default function LandingPage() {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-white to-gray-100 dark:from-gray-900 dark:to-black">
      {/* Animated background elements */}
      ...
      {!showContent && (
        ...
        >
          <div className="relative w-24 h-24">
            ...
            <div className="absolute inset-0 border-4 border-blue-500 rounded-full opacity-75 animate-pulse"></div>
            <div className="absolute inset-0 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xl font-bold">SaveMore</div>
          </div>
        </div>
      )}
      ...
      {/* Main Content */}
      <div
        className={`transition-all duration-1000 h-full w-full flex flex-col items-center justify-center ${
      ...
      >
        <div className="max-w-4xl px-6 py-10 mx-auto text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Dialog>
              <DialogTrigger asChild>
                <Button className="px-8 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-full transform transition hover:scale-105 shadow-lg hover:shadow-blue-500/25">
                  Get Started
                </Button>
              </DialogTrigger>
              <DialogContent className="w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl h-[80vh] overflow-y-auto rounded-2xl p-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border border-gray-200 dark:border-gray-800">
                <div className="p-6">
                  <Authentication />
                </div>
              </DialogContent>
