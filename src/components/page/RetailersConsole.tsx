...
import clsx from "clsx"; // Install clsx using `npm install clsx`
...
const Dashboard = () => {
  return (
    <div className="flex flex-1">
      <div className="p-2 md:p-10  border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col gap-1 flex-1 w-full h-full">
        {/* Header */}
          ...
          <div className="flex h-20 w-full rounded-lg dark:bg-neutral-800 align-middle justify-between px-2 ">
            ...
            <div>
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-[100vH] max-h-[150vH]">
                  <DialogHeader>
